...
<html>
   ...
   <body>
     ...
     <div style="padding-left: 20%;">
         ...
         @foreach($comment as $comment) <!-- Use $comments instead of $comment -->
             <div>
                 <b>{{ $comment->name }}</b>
                 <p>{{ $comment->comment }} </p>
         ...
         <div style="display: none;" class="replyDev">
